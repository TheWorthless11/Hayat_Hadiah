# Starting Rasa Server (PowerShell Version)
...
# Navigate to chatbot directory (using -LiteralPath to handle apostrophe)
Set-Location -LiteralPath "c:\xampp\htdocs\Hayat_Hadi'ah\chatbot"

# Start Rasa server
Write-Host "Starting Rasa server on http://localhost:5005" -ForegroundColor Green
Write-Host ""
